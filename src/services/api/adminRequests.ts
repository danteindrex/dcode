...
export async function createAdminRequest(
  ...
  const url = `${getAppBackendBaseUrl()}/api/oauth/organizations/${orgUUID}/admin_requests`
...
export async function getMyAdminRequests(
  ...
  let url = `${getAppBackendBaseUrl()}/api/oauth/organizations/${orgUUID}/admin_requests/me?request_type=${requestType}`
...
export async function checkAdminRequestEligibility(
  ...
  const url = `${getAppBackendBaseUrl()}/api/oauth/organizations/${orgUUID}/admin_requests/eligibility?request_type=${requestType}`
